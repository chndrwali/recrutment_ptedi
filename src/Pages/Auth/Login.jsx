        ...
        <main className="w-full max-w-md mx-auto p-6">
          <div className="mt-7  border border-gray-200 rounded-xl shadow-sm  dark:border-gray-700">
            <div className="p-4 sm:p-7">
              <h1 className="mt-4 text-2xl font-black text-foreground/90 tracking-tight sm:text-3xl md:text-4xl">Masuk</h1>
              ...
              <form onSubmit={handleLogin}>
                ...
                <div className="grid">
                  ...
                  <p className="text-sm text-center mt-2">
                    <span className="text-gray-400 mr-2">Belum punya akun?</span>
                    <Link to="/register" className="text-blue-500 font-semibold hover:underline hover:text-blue-500">
                      Daftar sekarang
                    </Link>
                  </p>
                </div>
